...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Linhas de Linguagem de Validação (Português do Brasil - pt_BR)
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir contêm as mensagens padrão de erro usadas pela
    | classe validadora do Laravel. Algumas dessas regras contêm múltiplas
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Atributos de Validação Amigáveis (pt-BR)
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas são usadas para trocar os nomes de atributos crus
    | por algo mais amigável ao usuário, como "endereço de e-mail" em vez
    | de "email". Isso ajuda as mensagens a serem muito mais limpas e naturais.
    |
    */
    ...
    'attributes' => [
        ...
        // Caixas
        'number' => 'número da caixa',
        'physical_location' => 'local físico',
        'box_quantity' => 'quantidade de caixas',
        'conference_date' => 'data da conferência',
        'commission_member_id' => 'conferente',
        'boxes' => 'caixas',

        // Documentos
        'box_id' => 'caixa',
        'item_number' => 'item dentro da caixa',
        'code' => 'código do documento',
        'descriptor' => 'descritor',
        'document_number' => 'número do documento',
        'title' => 'título',
        'document_date' => 'data do documento',
        'confidentiality' => 'nível de sigilo',
        'version' => 'versão',
        'is_copy' => 'informação da cópia',
        'file' => 'arquivo',
        ...
        'members' => 'membros da comissão',
        'members.*' => 'membro da comissão',
        'president_id' => 'presidente da comissão',
    ],
