        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-8">
                        <h3 class="text-lg font-semibold mb-4">Usuários e Permissões</h3>
                    ...
                    <div>
                        <h3 class="text-lg font-semibold mb-4">Papéis do Sistema</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            @foreach($roles as $role)
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
                                <h4 class="text-md font-semibold text-gray-900 dark:text-gray-100 mb-3">{{ $role->display_name }}</h4>
                                <div class="space-y-2">
                                    @foreach($role->permissions as $permission)
                                    <div class="flex items-center">
                                        <span class="text-sm text-gray-600 dark:text-gray-300">{{ $permission->display_name }}</span>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
