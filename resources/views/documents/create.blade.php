                    ...
                    <form action="{{ route('documents.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="col-span-1">
                                ...
                                <input type="text" name="box" id="box" value="{{ old('box') }}" required
                            ...
                            <div class="col-span-1">
                                ...
                                <select name="secrecy" id="secrecy"
                                    ...
                                    <option value="confidential" {{ old('secrecy') == 'confidential' ? 'selected' : '' }}>Confidencial</option>
                                    <option value="restricted" {{ old('secrecy') == 'restricted' ? 'selected' : '' }}>Restrito</option>
                                </select>
                            </div>
                            ...
                            <div class="col-span-1">
                                <label class="inline-flex items-center mt-6">
                                    <input type="checkbox" name="copy" value="1" {{ old('copy') ? 'checked' : '' }}
