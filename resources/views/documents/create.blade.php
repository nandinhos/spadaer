...
<x-app-layout>
    ...
    @section('header-title', 'Adicionar Novo Documento')
        ...
        <div class="flex flex-col items-start gap-4 sm:flex-row sm:items-center justify-between">
            <div>
                <h2 class="text-xl font-bold leading-tight text-gray-900 dark:text-white flex items-center gap-2">
                    <i class="fas fa-file-circle-plus text-primary dark:text-primary-light"></i>
                    <span>{{ __('Adicionar Novo Documento') }}</span>
                </h2>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Preencha os dados cadastrais, localização física e sigilo do documento arquivado.</p>
            </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                            ...
                            <div>
                                ...
                                <x-select-input id="box_id" name="box_id" required class="block w-full">
                                    <option value="" disabled @selected(old('box_id') === null)>
                            ...
                            <div>
                                ...
                                <x-text-input id="item_number" name="item_number" type="text" required
                                    class="block w-full" placeholder="Ex: 001, 002..." :value="old('item_number')" />
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                            ...
                            <div>
                                ...
                                <x-text-input id="document_number" name="document_number" type="text" required
                                    class="block w-full" placeholder="Ex: OF-2024-001" :value="old('document_number')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="code" name="code" type="text" class="block w-full"
                                    placeholder="Ex: COD-A4" :value="old('code')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="descriptor" name="descriptor" type="text" class="block w-full"
                                    placeholder="Ex: Administrativo, Técnico..." :value="old('descriptor')" />
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                            ...
                            <div>
                                ...
                                <x-text-input id="document_date" name="document_date" type="text" required
                                    class="block w-full" placeholder="Ex: JAN/2024, FEV/2023" :value="old('document_date')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="version" name="version" type="text" class="block w-full"
                                    placeholder="Ex: 1.0, Rev 2" :value="old('version')" />
                            ...
                            <div class="md:col-span-3">
                                ...
                                <x-text-input id="is_copy" name="is_copy" type="text" class="block w-full"
                                    placeholder="Ex: Cópia 1, Original arquivado, Revisão B" :value="old('is_copy')" />
        ...
        <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
            <x-ui.card>
                <div class="text-center py-8">
                    <i class="fas fa-lock text-4xl text-gray-400 dark:text-gray-600 mb-3"></i>
                    <p class="text-sm font-semibold text-gray-700 dark:text-gray-300">
                        {{ __('Você não tem permissão para criar documentos.') }}
                    </p>
                </div>
            </x-ui.card>
        </div>
